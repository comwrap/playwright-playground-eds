...
## Environments
- Preview: https://main--playwright-playground-eds--comwrap.aem.page/
- Live: https://main--playwright-playground-eds--comwrap.aem.live/
...
1. Open the `playwright-playground-eds` directory in your favorite IDE and start coding :)
